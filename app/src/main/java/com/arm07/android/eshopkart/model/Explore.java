...
public class Explore {
    ...
    public static String[] goods=new String[]{"All Good Deals","For the Home(115133)","Health & Beauty(64177)","Jewelry & Watches(45417)",
        "Women's Fashion","Electronics(32287)","Auto and Home Improvement(84902)","Sports & Outdoors(17231)","Baby,Kid & Toys(13677)",
        "Men's Fashion(23519)","Entertainment(5213)","Grocery(4216)","Pet Supplies(3294)","Collectibles(1332)"};
